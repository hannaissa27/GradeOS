...
export async function initializeTables() {
  ...
  try {
    // Note: Supabase client doesn't have direct SQL execution for users
    // Tables will be auto-created on first write attempt
    console.log('[GradeOS] Tables will be created on first write attempt');
    return { success: true };
  } catch (error) {
